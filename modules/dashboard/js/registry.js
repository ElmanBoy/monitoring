...
var el_dashboard_registry = {
    ...
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_dashboard_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_dashboard_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_dashboard_registry.getPropsInRegistry();
        });
        ...
        /*$(document).on("content_load", function (){
            if (el_tools.function_exists("el_dashboard_registry.getAllPropsInCreateRegistry")) {
                el_dashboard_registry.getAllPropsInCreateRegistry();
            }
        });*/

        $("select[name=fromdb]").on("change", function (){
            el_dashboard_registry.showFieldsFromDB($(this).val(), $("input[name=selected_field]").val());
        });
        ...
        $(".pop_up_body .new_institution").off("click").on("click", function(e){
            e.preventDefault();
            el_dashboard_registry.cloneInstitution();
        });
        ...
        el_dashboard_registry.bindPassword();
        el_dashboard_registry.bindLoginAlias();
        el_dashboard_registry.getPropsInRegistry();
    ...
    setNewRegistryData: function (){
        ...
        if ($items.length > 0) {
            ...
            $.post("/", {ajax: 1, action: "buildForm", props: newRegistryData}, function (data){
                ...
                el_dashboard_registry.bindDadata();
                el_dashboard_registry.bindSetOrgByType($(".institutions:last"));
                el_dashboard_registry.bindPassword();
                el_dashboard_registry.bindLoginAlias();
                el_dashboard_registry.bindTipsy();
                el_dashboard_registry.bindCalendar();
    ...
    cloneInstitution: function(){
        ...
        el_dashboard_registry.bindCalendar();
        el_dashboard_registry.scrollToLastInstitution();
    },
