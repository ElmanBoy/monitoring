...
$registry = $db->selectOne('checkprops', ' where id = ?', [intval($_POST['params'])]);
    ...
    <div class='pop_up drag' style='width: 60vw;'>
        ...
        <div class='pop_up_body'>
            <form class='ajaxFrm' id='registry_edit' onsubmit='return false'>
                <input type='hidden' name='path' value='checklists/props'>
                <div class='tab-panel' id='tab_main-panel'>
                    ...
                    <select data-label="Родительский справочник" name="parent">
                        ...
                        <?
                        $radio_values = json_decode($registry->checkbox_values, true);
                        ?>
