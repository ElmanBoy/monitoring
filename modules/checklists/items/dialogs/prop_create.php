...
$select_block = intval($_POST['params']);
...
<div class="pop_up drag" style='width: 60vw;'>
    <div class="title handle">
        ...
        <div class="name">Создать пункт чек-листа</div>
                ...
                <div class="group">
                    <div class="item w_100 required">
                        <div class='el_data'>
                            ...
                            <textarea class='el_textarea' name='prop_name'></textarea>
                        </div>
                    </div>
                    ...
                    <div class='item w_50'>
                        <select data-label='Входит в блок' name='block_id'>
                            ...
                            <? foreach ($blocks['array'] as $id => $name) { ?>
                                <option value="<?= $id ?>"<?=($id == $select_block ? ' selected' : '')?>><?= $name ?></option>
                            <? } ?>
                        </select>
                    </div>
                        ...
                        <div class='el_data horizontal'>
                            ...
                            <div class='custom_checkbox'>
                                <label class='container'>
                                    ...
                                    <input type='radio' class='for_self' name='item_type' value='0' checked="checked">
                    ...
                    <div class='item w_100 field_option' id='html_value'>
                        <div class='el_data'>
                            ...
                            <textarea name='default_value' class='html_editor el_input'></textarea>
                        </div>
                    </div>
                        ...
                        <div style='margin-top: -10px; margin-right: 50px;'>
                            ...
                            <div class='custom_checkbox'>
                                <label class='container'> Выпадающий список (одиночный выбор)
                                    <input type='radio' name='from_db_view' value='0' checked="checked">
                                    <span class="checkmark radio"></span></label>
                            </div>
                            <div class='custom_checkbox'>
