$(document).ready(function(){
    el_app.mainInit();
    el_documents_registry.create_init();
});
...
var el_documents_registry = {
    ...
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_documents_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_documents_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_documents_registry.getPropsInRegistry();
        });
        ...
        /*$(document).on("content_load", function (){
            if (el_tools.function_exists("el_documents_registry.getAllPropsInCreateRegistry")) {
                el_documents_registry.getAllPropsInCreateRegistry();
            }
        });*/

        $("select[name=fromdb]").on("change", function (){
            el_documents_registry.showFieldsFromDB($(this).val(), $("input[name=selected_field]").val());
        });
        ...
        $(".pop_up_body .new_institution").off("click").on("click", function(e){
            e.preventDefault();
            el_documents_registry.cloneInstitution();
        });
        ...
        el_documents_registry.bindPassword();
        el_documents_registry.bindLoginAlias();
        el_documents_registry.getPropsInRegistry();
    ...
    getPropsInRegistry: function (){
        ...
        el_documents_registry.setNewRegistryData();
    ...
    setNewRegistryData: function (){
        ...
        if ($items.length > 0) {
            ...
            $.post("/", {ajax: 1, action: "buildForm", props: newRegistryData}, function (data){
                ...
                el_documents_registry.bindDadata();
                el_documents_registry.bindSetOrgByType($(".institutions:last"));
                el_documents_registry.bindPassword();
                el_documents_registry.bindLoginAlias();
                el_documents_registry.bindTipsy();
                el_documents_registry.bindCalendar();
    ...
    cloneInstitution: function(){
        ...
        el_documents_registry.bindCalendar();
        el_documents_registry.scrollToLastInstitution();
    },
