    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            let $registry_items = $('#registry_items_edit .item'),
                $registry_agreement_list_group = $('#registry_items_edit .agreement_list_group, ' +
                    '#registry_items_edit .agreement_list_group .item, ' +
            ...
            $("#registry_items_edit [name='documentacial']").off('change').on('change', function () {
                ...
                $.post("/", {ajax: 1, action: "getTemplateByDocType", docType: val}, function(data){
                    $("#registry_items_edit [name='document']").html(data).trigger("chosen:updated");
                });
            });
        });
    </script>
