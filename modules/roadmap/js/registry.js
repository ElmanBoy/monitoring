$(document).ready(function(){
    el_app.mainInit();
    el_roadmap_registry.create_init();
});
...
var el_roadmap_registry = {
    ...
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_roadmap_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_roadmap_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_roadmap_registry.getPropsInRegistry();
        });
        ...
        /*$(document).on("content_load", function (){
            if (el_tools.function_exists("el_roadmap_registry.getAllPropsInCreateRegistry")) {
                el_roadmap_registry.getAllPropsInCreateRegistry();
            }
        });*/

        $("select[name=fromdb]").on("change", function (){
            el_roadmap_registry.showFieldsFromDB($(this).val(), $("input[name=selected_field]").val());
        });
        ...
        el_roadmap_registry.bindPassword();
        el_roadmap_registry.bindLoginAlias();
        el_roadmap_registry.getPropsInRegistry();
    ...
    getPropsInRegistry: function (){
        ...
        el_roadmap_registry.setNewRegistryData();
    ...
    setNewRegistryData: function (){
        ...
        if ($items.length > 0) {
            ...
            $.post("/", {ajax: 1, action: "buildForm", props: newRegistryData}, function (data){
                ...
                el_roadmap_registry.bindPassword();
                el_roadmap_registry.bindLoginAlias();
                el_roadmap_registry.bindTipsy();
                el_roadmap_registry.bindCalendar();
    ...
    cloneInstitution: function(){
        ...
        el_roadmap_registry.bindCalendar();
        el_roadmap_registry.scrollToLastInstitution();
    },
