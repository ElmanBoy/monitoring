...
var el_users_registry = {
    //Инициализация контролов в разделе "Учреждения"
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_users_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_users_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_users_registry.getPropsInRegistry();
        });
        ...
        $(document).on("content_load", function (){
            el_users_registry.getAllPropsInCreateRegistry();
        });

        $("select[name=fromdb]").on("change", function (){
            el_users_registry.showFieldsFromDB($(this).val(), $("input[name=selected_field]").val());
        });
        ...
        $(".pop_up_body .new_institution").off("click").on("click", function(e){
            e.preventDefault();
            el_users_registry.cloneInstitution();
        });

        $(".pop_up_body .new_staff").off("click").on("click", function(e){
            e.preventDefault();
            el_users_registry.cloneStaff();
        });
        ...
        $(".pop_up_body .institutions:last input[name='check_periods[]']")
            .flatpickr({
                defaultDate: el_users_registry.getPrevPeriod(),
                locale: 'ru',
                mode: 'range',
                time_24hr: true,
                dateFormat: 'Y-m-d',
        ...
        el_users_registry.bindSetOrgByType();
        el_users_registry.bindPassword();
        el_users_registry.bindLoginAlias();
        el_users_registry.getPropsInRegistry();
        el_users_registry.bindDadata();
        el_app.sort_init();
        el_app.filter_init();
    },
    ...
    getPropsInRegistry: function (){
        ...
        el_users_registry.setNewRegistryData();
    ...
    setNewRegistryData: function (){
        ...
        if ($items.length > 0) {
            ...
            $.post("/", {ajax: 1, action: "buildForm", props: newRegistryData}, function (data){
                ...
                el_users_registry.bindPassword();
                el_users_registry.bindLoginAlias();
                el_users_registry.bindTipsy();
                el_users_registry.bindCalendar();
    ...
    cloneInstitution: function(){
        ...
        if(institutions_counter > 1){
            ...
            $(".institutions .clear").off("click").on("click", function (){
                $(this).closest(".institutions").remove();
                el_users_registry.setItemsNumbers($(".pop_up_body .institutions"), "Учреждение");
                institutions_counter--;
            });
        }
        ...
        el_users_registry.bindCalendar();
        el_users_registry.scrollToLastInstitution();
    },
    ...
    cloneStaff: function(){
        ...
        if(staffs_counter > 1){
            ...
            $(".staff .clear").off("click").on("click", function (){
                ...
                el_users_registry.setItemsNumbers($(".pop_up_body .staff"), "Учреждение");
                staffs_counter--;
            });
        }
        ...
        el_users_registry.setItemsNumbers($(".pop_up_body .staff"), "Сотрудник");
        el_users_registry.bindTipsy();
        el_users_registry.bindCalendar();
        el_users_registry.scrollToLastInstitution();
    },
