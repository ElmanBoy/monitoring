        ...
        <div class="content<?=$_COOKIE['widthPage'] == 'wide' ? ' wide' : ''?>">
            ...
            <div class="main_data">
                ...
                if(isset($_GET['id']) && intval($_GET['id']) > 0){
                    include_once $_SERVER['DOCUMENT_ROOT'] . '/modules/institutions/pages/index_id_ajax.php';
                }else {
                    include_once $_SERVER['DOCUMENT_ROOT'] . '/modules/institutions/pages/index_ajax.php';
                }
                ?>
            </div>
        </div>
