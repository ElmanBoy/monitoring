...
<div class="pop_up drag" style='width: 60vw;'>
    <div class="title handle">
        ...
        <div class="name">Редактирование объекта контроля &laquo;<?=$registry->name?>&raquo;</div>
    ...
    <div class="pop_up_body">
        <form class="ajaxFrm noreset" id="registry_items_edit" onsubmit="return false">
            ...
            <input type='hidden' name='geo_lat' value="<?=$registry->geo_lat?>">
            <input type='hidden' name='geo_lon' value="<?=$registry->geo_lon?>">
            <?
    ...
    <script src='/modules/institutions/js/registry.js'></script>
    <script>
        el_app.mainInit();
