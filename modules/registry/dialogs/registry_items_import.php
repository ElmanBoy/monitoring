    ...
    <div class="pop_up_body">
        <form class="ajaxFrm noreset" id="registry_items_import" onsubmit="return false">
            ...
            <div class="group">
                <?/*div class='item w_50'>
                    <div class='el_data'>
                        <label>Номер строки с заголовками</label>
                        <input class='el_input' type='number' name='headersRow' value='1' step="1">
                    </div>
                </div*/?>
                <div class='item w_100'>
                    <div class='el_data'>
                        <label>Разделитель полей</label>
                        <input class='el_input' type='text' name='separator' maxlength="1" value=';' style="width: 35px">
                    </div>
                </div>
                <div class='item w_100'>
                    <div class='el_data'>
                        <div class='custom_checkbox'>
                            <label class='container'>
                                <span class='label-text'>Обновить данные, если найдены аналогичные элементы справочника</span>
                                <input type='checkbox' checked='checked' name='rewriteData' id='rewriteData'
