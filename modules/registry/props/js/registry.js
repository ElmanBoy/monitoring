...
var el_regprops_registry = {
    ...
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_regprops_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_regprops_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_regprops_registry.getPropsInRegistry();
        });
        ...
        $("select[name=fromdb]").on("change", function (){
            el_regprops_registry.showFieldsFromDB(
                $(this).val(),
    ...
    getPropsInRegistry: function (){
        ...
        el_regprops_registry.setNewRegistryData();
