...
var el_assigned_registry = {
    ...
    create_init: function(){
        ...
        $(".new_check").on("click", function (e){
            ...
            el_assigned_registry.setCheckNumber();
        ...
        $(".new_option").on("click", function (e){
            ...
            el_assigned_registry.setOptionNumber();
        ...
        $("#add_props").on("click", function (e){
            ...
            el_assigned_registry.getPropsInRegistry();
        });
        ...
        $(document).on("content_load", function (){
            el_assigned_registry.getAllPropsInCreateRegistry();
        });

        $("select[name=fromdb]").on("change", function (){
            el_assigned_registry.showFieldsFromDB($(this).val(), $("input[name=selected_field]").val());
        });
        ...
        $(".pop_up_body .new_institution").off("click").on("click", function(e){
            e.preventDefault();
            el_assigned_registry.cloneInstitution();
        });

        $(".pop_up_body .new_staff").off("click").on("click", function(e){
            e.preventDefault();
            el_assigned_registry.cloneStaff();
        });
        ...
        $(".pop_up_body .institutions:last input[name='check_periods[]']")
            .flatpickr({
                defaultDate: el_assigned_registry.getPrevPeriod(),
                locale: 'ru',
                mode: 'range',
                time_24hr: true,
                dateFormat: 'Y-m-d',
        ...
        el_assigned_registry.bindSetOrgByType();
        el_assigned_registry.bindPassword();
        el_assigned_registry.bindLoginAlias();
        el_assigned_registry.getPropsInRegistry();
    ...
    getPropsInRegistry: function (){
        ...
        el_assigned_registry.setNewRegistryData();
    ...
    setNewRegistryData: function (){
        ...
        if ($items.length > 0) {
            ...
            $.post("/", {ajax: 1, action: "buildForm", props: newRegistryData}, function (data){
                ...
                el_assigned_registry.bindPassword();
                el_assigned_registry.bindLoginAlias();
                el_assigned_registry.bindTipsy();
                el_assigned_registry.bindCalendar();
    ...
    cloneInstitution: function(){
        ...
        if(institutions_counter > 1){
            ...
            $(".institutions .clear").off("click").on("click", function (){
                $(this).closest(".institutions").remove();
                el_assigned_registry.setItemsNumbers($(".pop_up_body .institutions"), "Учреждение");
                institutions_counter--;
            });
        }
        ...
        el_assigned_registry.bindCalendar();
        el_assigned_registry.scrollToLastInstitution();
    },
    ...
    cloneStaff: function(){
        ...
        if(staffs_counter > 1){
            ...
            $(".staff .clear").off("click").on("click", function (){
                ...
                el_assigned_registry.setItemsNumbers($(".pop_up_body .staff"), "Учреждение");
                staffs_counter--;
            });
        }
        ...
        el_assigned_registry.setItemsNumbers($(".pop_up_body .staff"), "Сотрудник");
        $(".pop_up_body .staff:last [name='is_head[" + staffs_counter + "]'").prop("checked", false);
        el_assigned_registry.bindTipsy();
        el_assigned_registry.bindCalendar();
        el_assigned_registry.scrollToLastInstitution();
