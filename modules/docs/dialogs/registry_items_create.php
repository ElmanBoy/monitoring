...
?>
<style>
    .agreement_list_group, .upload_link{
        display: none;
    }
</style>
<div class="pop_up drag" style='width: 65vw;'>
    <div class="title handle">
        ...
        <div class="name">Новый шаблон документа</div>
    ...
    $(document).ready(function(){
        ...
        $("#registry_items_create [name='documentacial']").off("change").on("change", function(){
            let val = $(this).val(),
                ...
                $agreement_list_group = $('.agreement_list_group, #registry_items_create .agreement_list_group .item, ' +
            ...
            switch(parseInt(val)){
                case 6:
                    ...
                    $('#registry_items_create .item:nth-of-type(1),' +
                       '#registry_items_create .item:nth-of-type(2), ' +
                        '#registry_items_create .item:nth-child(n+10)').show();
                ...
                default:
                    ...
                    $('#registry_items_create .item:nth-of-type(1),' +
                        '#registry_items_create .item:nth-of-type(2), ' +
                        '#registry_items_create .item:nth-child(-n+8)').show();
