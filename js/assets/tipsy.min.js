...
(function (e) {
    e.fn.tipsy = function (t) {
        ...
        return this.each(function (t, r) {
            var i = e(r), s = ".tipsy", o = e('<div class="tipsy"></div>'),
                ...
                a = {
                    init: function () {
                        ...
                        var t = {top: 0, left: 0},
                            ...
                            s = r.split("-"), l = a.hasAttr(n.attr + "-offset") ? i.attr(n.attr + "-offset") : n.offset,
                            c = {
                                offsetTop: i.offset().top,
                                offsetLeft: i.offset().left,
                                width: i.outerWidth(),
                                height: i.outerHeight()
                            }, h = {width: o.outerWidth(), height: o.outerHeight()}, d = {
                                width: $(window).outerWidth(),
                                height: $(window).outerHeight(),
                                scrollTop: $(window).scrollTop(),
                                scrollLeft: $(window).scrollLeft()
                            };
                        if ($.inArray(r, u) == -1 || $.inArray(r, a._lsWpI) !== -1) {
                            a._hide();
                            return t
                        } else {
                            a._lsWpI.push(r)
