...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    const MINIMAL_RAW_EN_LOCALE = {
        ...
        moreLinkText: 'еще',
        noEventsText: 'Нет событий для показа',
    };
    const RAW_EN_LOCALE = Object.assign(Object.assign({}, MINIMAL_RAW_EN_LOCALE), { 
        ...
        }, viewHint: 'Вид $0', navLinkHint: 'Перейти к $0', moreLinkHint(eventCnt) {
            return `Показать ${eventCnt} ещё событи${eventCnt === 1 ? 'е' : 'й'}`;
        } });
    ...
    */
    ...
    class TimelineHeader extends BaseComponent {
        ...
        render() {
            ...
            return (y(NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => (y("div", { className: "fc-timeline-header", ref: this.rootElRef },
    ...
    class TimelineGrid extends DateComponent {
        ...
        render() {
            ...
            return (y("div", { className: "fc-timeline-body", ref: this.handeEl, style: {
                ...
                y(NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => (y(_, null,
    ...
    class ResourceTimelineGrid extends DateComponent {
        ...
        render() {
            ...
            return (y("div", { ref: this.handleEl, className: [
                ...
                y(NowTimer, { unit: timerUnit, unitValue: timeUnitValue }, (nowDate, todayRange) => (y(_, null,
