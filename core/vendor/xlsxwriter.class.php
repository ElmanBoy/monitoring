...
class XLSXWriter
{
	...
	public function writeSheetHeader($sheet_name, array $header_types, $col_options = null)
	{
		...
		if (!$suppress_row)
		{
			...
			$sheet->file_writer->write('<row collapsed="false" customFormat="false" customHeight="false" hidden="false" WrapText="true" ht="12.1" outlineLevel="0" r="' . ($sheet->row_count+1) . '">');
	...
	protected function writeStylesXML()
	{
		...
		$file->write(		'<alignment horizontal="general" indent="0" shrinkToFit="false" textRotation="0" vertical="bottom" wrapText="true"/>');
