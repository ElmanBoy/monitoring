...
<head>
    ...
    <link href="/css/start.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    <link href="/css/fonts.css" rel="stylesheet"/>
    <link href="/css/button.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    <link href="/css/check-radio.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    <link href="/css/el-data.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    <link href="/css/pop_up.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    <!-- <link href="/css/pie-charts.css" rel="stylesheet" />-->
    <link href="/css/style00.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
    ...
    <link href="/js/assets/frappe-gantt/dist/frappe-gantt.css?v=<?= $gui->genpass() ?>" rel='stylesheet'/>
    <link href="/css/breadcrumb.css?v=<?= $gui->genpass() ?>" rel='stylesheet'/>
    <script src="/js/assets/jquery-3.6.0.min.js"></script>
    <script src="/js/assets/jquery.el_select1.js?v=<?= $gui->genpass() ?>"></script>
    <script src="/js/assets/jquery.el_suggest.js?v=<?= $gui->genpass() ?>"></script>
    ...
    <script src="/js/core/tools.js?v=<?= $gui->genpass() ?>"></script>
    <script src="/js/core/app.js?v=<?= $gui->genpass() ?>"></script>
    <script src="/js/core/suggest.js?v=<?= $gui->genpass() ?>"></script>
    <script src="/js/core/autocomplete.js?v=<?= $gui->genpass() ?>"></script>
    ...
    <script src='/js/assets/quarter_select.js?v=<?= $gui->genpass() ?>'></script>
    <script src="/js/assets/tinymce/js/tinymce/tinymce.min.js"></script>
    <script src="/js/assets/frappe-gantt/dist/frappe-gantt.umd.js?v=<?= $gui->genpass() ?>"></script>
    ...
    <script src='https://api-maps.yandex.ru/2.1/?lang=ru-RU&amp;apikey=4fb6d7dc-97e6-4520-af12-1fda7d2bfe41' type='text/javascript'></script>
    <script>
    ...
    <link href="/css/custom.css?v=<?= $gui->genpass() ?>" rel="stylesheet"/>
