...
<form action="<?php echo $editFormAction; ?>" name="edit" method="POST">
  ...
  <tr>
    ...
    <td width="90%"><textarea name="ptext" cols="45" rows="5" id="ptext"><?php echo $row_desc['ptext']; ?></textarea></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><input type="submit" name="Submit" value="Сохранить" />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" name="Submit2" value="Закрыть" onClick="window.close()"></td>
  </tr>
